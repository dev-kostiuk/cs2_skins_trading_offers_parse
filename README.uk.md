...
```bash
cd cs2_skins_trading_offers_parse
npm install
...
| `DMARKET_ITEMS_DMARKET_DB_PATH` | `../cs2_skins_trading_database/items_dmarket.db` | БД черги айтемів |
| `DMARKET_OFFERS_DMARKET_DB_PATH` | `../cs2_skins_trading_database/offers_dmarket.db` | БД офферів (вихід) |
...
| Параметр | За замовч. | Опис |
|----------|-----------|------|
| `WAXPEER_DB_PATH` | `../cs2_skins_trading_database/offers_waxpeer.db` | Шлях до БД Waxpeer |
| `WAXPEER_LOOP_SLEEP_MS` | `300000` | Інтервал циклу (5 хв) |
| `BITSKINS_DB_PATH` | `../cs2_skins_trading_database/offers_bitskins.db` | Шлях до БД BitSkins |
| `BITSKINS_LOOP_SLEEP_MS` | `300000` | Інтервал циклу (5 хв) |
| `LOOTFARM_DB_PATH` | `../cs2_skins_trading_database/offers_lootfarm.db` | Шлях до БД Loot.Farm |
